...
Point_6 = (110, 162)  #p6口
Point_7 = (195, 49)  #p7口
Point_8 = (470, 49)  #p8口           //出口公共点   即exit
Point_a = (440, 250) #a,入口         //单独内圈
Point_b = (300, 39) #b,出口         //单独内圈
...
def way():
    ...
    #1点到a点
    p1ay = np.arange(Point_1[1],Point_a[1])
    ...
    #a点到2点
    a2y = np.arange(Point_a[1],Point_2[1])
    ...
    #3点到4点
    p34x = np.arange(Point_3[0],Point_4[0],-1)
   ...
   # print(p45)
    ...
    p56y = np.arange(Point_5[1],Point_6[1],-1)
    ...
    p7bx = np.arange(Point_7[0],Point_b[0])
    ...
    #b点到8点
    b8x = np.arange(Point_b[0],Point_8[0])
